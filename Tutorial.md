...
$$ \begin{bmatrix}x'\\y'\\z'\end{bmatrix}=\begin{bmatrix}a&b&c\\d&e&f\\h&i&j\end{bmatrix}\begin{bmatrix}x\\y\\z\end{bmatrix}
+\begin{bmatrix}t_x\\t_y\\t_z\end{bmatrix}$$
So we need a unified way to represent all transformations. We use $ (\mathbf{x}, \mathbf{y}, \mathbf{z}, 1)^\mathbf{T} $ 
for a 3-D point and $ (\mathbf{x}, \mathbf{y}, \mathbf{z}, 0) $ for a 3-D vector.
The previous formula could be replaced into:
$$ \begin{bmatrix}x'\\y'\\z'\\1\end{bmatrix}=\begin{bmatrix}a&b&c&t_x\\d&e&f&t_y\\h&i&j&t_z\\0&0&0&1\end{bmatrix}
...
- __Cross: $ p\times q=(w_1w_2-x_1x_2-y_1y_2-z_1z_2)+ 
 (w_1x_2+x_1w_2+y_1z_2-y_2z_1)i+(w_1y_2-x_1z_2+y_1w_2+z_1x_2)j+(w_1z_2=z_1x_2-y_1x_2+z_1w_2)k$__
...
2. Normalized Linear Interpolation (Nlerp):
...
4. Spherical and Quadrangle Spline Interpolation (Squad):
